                                ...
                                <ul>
                                    <li>
                                        <div className="colum-gap">
                                            <div className="colum-wrap">
                                                <div className="img-box">
                                                    <img src="./img/latest-blog6.jpg" alt="latest-blog6"/>
                                                </div>
                                    ...
                                    <li>
                                        <div className="colum-gap">
                                            <div className="colum-wrap">
                                                <div className="img-box">
                                                    <img src="./img/latest-blog5.jpg" alt="latest-blog6"/>
                                                </div>
                                                <div className="text-box">
                                                    <div className="text-gap">
                                                        <div className="text-content">
                                                            <h4>Bring the experience to life</h4>
                                                            <p>Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
                                                            <span><a href="#!">Explore services<i className="material-icons">arrow_forward</i></a></span>
                                                        </div>
                                                    </div>
                                    ...
                                    <li>
                                        <div className="colum-gap">
                                            <div className="colum-wrap">
                                                <div className="img-box">
                                                    <img src="./img/latest-blog7.jpg" alt="latest-blog6"/>
                                                </div>
                                                <div className="text-box">
                                                    <div className="text-gap">
                                                        <div className="text-content">
                                                            <h4>Strategise chart the course</h4>
                                                            <p>Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
                                                            <span><a href="#!">Explore services<i className="material-icons">arrow_forward</i></a></span>
                                                        </div>
                                                    </div>
